...
public class CompanyEmpWage {
	...
	public String toString() {
		return "CompanyEmpWage [companyName=" + companyName + ", wagePerHr=" + wagePerHr + ", totalWorkingDays="
				+ totalWorkingDays + ", totalWorkingHrs=" + totalWorkingHrs + ", totalEmpWage=" + totalEmpWage + "]";
	}
